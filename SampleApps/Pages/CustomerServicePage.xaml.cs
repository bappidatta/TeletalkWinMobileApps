...
namespace SampleApps.Pages
{
    ...
    /// </summary>
    public sealed partial class CustomerServicePage : Page
    {
        ...
        private void customerServiceListView_Loaded(object sender, RoutedEventArgs e)
        {
            customerServiceListView.ItemsSource = data.customer_cares;
        }
